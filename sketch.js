...
function setup() 
{
  ...
  //ground = new Ground(250, 690,20);
  blink.frameDelay = 20;
  eat.frameDelay = 20;

  bunny = createSprite(350, 130, 100 ,100);
  bunny.scale = 0.2;
  ...
  bubble = createSprite(290, 460, 10, 10);
  ...
  highWall = new Ground(350, 200, 90, 10);
